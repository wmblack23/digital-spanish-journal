...
- While additional features will be added in the future, **simplicity** is the core design concept. It is solely a web application for storing Spanish writing and getting immediate feedback from the Chat GPT API.
---
